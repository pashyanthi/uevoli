class Form {
    ...
    display(){
      this.title.html("Bouncing Ball Runner");
   ...
   var player = this.input.value();
        ...
        this.R1.html('1)This is a single-player game,Always try to be Active :) .');
        this.R2.html('2)Press space to make the ball bounce and be quick.');
        this.R3.html('3)The Magic lines are to help you play the game,you can jump on it.');
        this.R4.html("4)Do not  make the ball touch the ground or else you will loose.");
        this.R5.html("5)");
        //positions
